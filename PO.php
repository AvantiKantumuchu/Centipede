...
<div>
	...
	<form action="PO.php" method="POST">		    
		<input type= "search" name= "valueToSearch" placeholder= "Enter PO Number" >	    	
...
<div><br><br>
<h1 align="center" style="color:white">PO REPORT </h1> 
<h2 style="color:white"> PO DETAILS </h2>
...
<tr>
	...
	<th>
		PO Buying Factory Code
	</th>
	<th>
		PO Receiving Factory Code
	</th>
	<th>
		PO Issue Year
	</th>
...
<tbody>
	<?php
										...
										if(isset($_POST['valueToSearch']))
										{
											...
											$query = "SELECT * FROM PO WHERE PONumber LIKE '%".$valueToSearch."'";
											$searchResult = mysqli_query($con,$query);
										}
										else
										{
											$searchResult = mysqli_query($con,"SELECT * FROM PO");
										...
										while($row = mysqli_fetch_array($searchResult))
										{
											echo"<tr>
												<td>".$row['PONumber']."</td>
												<td>".$row['POBuyingFactoryCode']."</td>
												<td>".$row['POReceivingFactoryCode']."</td>
												<td>".$row['POIssueYear']."</td>
												<td>".$row['POIssueMonth']."</td>
												<td>".$row['POIssueDay']."</td>
...
<h2 style="color:white"> PO LINE DETAILS </h2>
<div>
<table bgcolor="#b3cccc">
<thead>
<tr>
...
<tbody>
	<?php
										...
										{
											$valueToSearch = $_POST['valueToSearch'];
											$query = "SELECT * FROM POLine WHERE PONumber LIKE '%".$valueToSearch."'";
											$searchResult = mysqli_query($con,$query);
										}
										else
										{
											$searchResult = mysqli_query($con,"SELECT * FROM POLine");
										...
										while($row = mysqli_fetch_array($searchResult))
										{
											echo"<tr>
												<td>".$row['PONumber']."</td>
												<td>".$row['POLineNumber']."</td>
												<td>".$row['POLineDescription']."</td>
												<td>".$row['POLineQuantity']."</td>
												<td>".$row['POLineUnitPrice']."</td>
												<td>".$row['POLineCurrencyCode']."</td>
												</tr>";
										}
									?>
</tbody>
