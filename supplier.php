...
<div>
	...
	<form action="supplier.php" method="POST" >		    
		<input type="search" name="valueToSearch" placeholder="Enter Supplier Code ">		    	
...
<div> <br><br>
<h1 align="center" style="color:white">SUPPLIER REPORT</h1>
...
<tbody>
	<?php
										...
										if(isset($_POST['valueToSearch']))
										{
											...
											$query = "SELECT * FROM Supplier WHERE SupplierCode LIKE '%".$valueToSearch."'";
											$searchResult = mysqli_query($con,$query);
										}
										else
										{
											$searchResult = mysqli_query($con,"SELECT * FROM Supplier");
										}
